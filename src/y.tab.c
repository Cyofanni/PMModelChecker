...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from src/myparser.yacc  */
...
const int YY_parse_CLASS::AND_TOK=258;
const int YY_parse_CLASS::BOX_TOK=259;
const int YY_parse_CLASS::PHI_TOK=260;
const int YY_parse_CLASS::DIAMOND_TOK=261;
const int YY_parse_CLASS::FALSE_TOK=262;
const int YY_parse_CLASS::PHI_PROP_TOK=263;
const int YY_parse_CLASS::EQ_TOK=264;
const int YY_parse_CLASS::PROP_TOK=265;
const int YY_parse_CLASS::EQMAX_TOK=266;
const int YY_parse_CLASS::ATOM_TOK=267;
const int YY_parse_CLASS::EQMIN_TOK=268;
const int YY_parse_CLASS::TRUE_TOK=269;
const int YY_parse_CLASS::ID_TOK=270;
const int YY_parse_CLASS::OR_TOK=271;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 271 ? yytranslate[x] : 25)
...
static const short yyprhs[] = {     0,
     0,     2,     5,     9,    10,    14,    18,    22,    26,    30,
    34,    38,    40,    42,    44,    46,    48,    52,    56,    59,
    62
};

static const short yyrhs[] = {    21,
     0,    21,    17,     0,    21,    22,    17,     0,     0,    15,
    13,    24,     0,    15,    11,    24,     0,     5,     9,    23,
     0,     8,     9,    23,     0,    23,     3,    23,     0,    23,
    16,    23,     0,    18,    23,    19,     0,    12,     0,    14,
     0,     7,     0,    15,     0,    10,     0,    18,    24,    19,
     0,    24,     3,    24,     0,     4,    24,     0,     6,    24,
     0,    24,    16,    24,     0
};
...
static const short yyrline[] = { 0,
    44,    46,    47,    48,    50,    51,    52,    53,    55,    56,
    57,    58,    59,    60,    62,    63,    64,    65,    66,    67,
    68
};

static const char * const yytname[] = {   "$","error","$illegal.","AND_TOK",
"BOX_TOK","PHI_TOK","DIAMOND_TOK","FALSE_TOK","PHI_PROP_TOK","EQ_TOK","PROP_TOK",
"EQMAX_TOK","ATOM_TOK","EQMIN_TOK","TRUE_TOK","ID_TOK","OR_TOK","'\\n'","'('",
"')'","system","equationlist","equation","expr_move","expr_eq",""
};
#endif
...
static const short yydefact[] = {     4,
     1,     0,     0,     0,     2,     0,     0,     0,     0,     0,
     3,    14,    12,    13,     0,     7,     8,     0,     0,    16,
    15,     0,     6,     5,     0,     0,     0,    19,    20,     0,
     0,     0,    11,     9,    10,    17,    18,    21,     0,     0,
     0
};
...
static const short yypact[] = {-32768,
    26,    -8,    -4,    16,-32768,    -7,    32,    32,    22,    22,
-32768,-32768,-32768,-32768,    32,     1,     1,    22,    22,-32768,
-32768,    22,     4,     4,    -1,    32,    32,    -5,    -5,     0,
    22,    22,-32768,     7,-32768,-32768,    -5,-32768,    14,    30,
-32768
};
...
static const short yytable[] = {    24,
     7,    26,    31,    26,     8,    17,    31,    28,    29,    11,
    32,    30,    25,    40,    27,    32,    27,    33,    36,    32,
    37,    38,    27,    34,    35,    18,     9,    19,    10,    41,
     2,    20,     0,     3,     0,     0,    21,     0,    12,    22,
     4,     0,     5,    13,     0,    14,     0,     0,     0,    15
};

static const short yycheck[] = {    10,
     9,     3,     3,     3,     9,     8,     3,    18,    19,    17,
    16,    22,    15,     0,    16,    16,    16,    19,    19,    16,
    31,    32,    16,    26,    27,     4,    11,     6,    13,     0,
     5,    10,    -1,     8,    -1,    -1,    15,    -1,     7,    18,
    15,    -1,    17,    12,    -1,    14,    -1,    -1,    -1,    18
};
...
case 1:
#line 44 "src/myparser.yacc"
{yyval.sys = new EqSystem(yyvsp[0].equations); root = yyval.sys;;
    break;}
case 2:
#line 46 "src/myparser.yacc"
{yyval.equations = yyvsp[-1].equations;;
    break;}
case 3:
#line 47 "src/myparser.yacc"
{yyval.equations = yyvsp[-2].equations;yyvsp[-2].equations->push_back(yyvsp[-1].eq);;
    break;}
case 4:
#line 48 "src/myparser.yacc"
{yyval.equations = new vector<Equation*>();;
    break;}
case 5:
#line 50 "src/myparser.yacc"
{yyval.eq = new Equation(yyvsp[-2].id,yyvsp[-1].equal,yyvsp[0].expnode);;
    break;}
case 6:
#line 51 "src/myparser.yacc"
{yyval.eq = new Equation(yyvsp[-2].id,yyvsp[-1].equal,yyvsp[0].expnode);;
    break;}
case 7:
#line 52 "src/myparser.yacc"
{yyval.eq = new Equation(yyvsp[-2].id,yyvsp[-1].equal,yyvsp[0].expnode);;
    break;}
case 8:
#line 53 "src/myparser.yacc"
{yyval.eq = new Equation(yyvsp[-2].id,yyvsp[-1].equal,yyvsp[0].expnode);;
    break;}
case 9:
#line 55 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op,yyvsp[-2].expnode,yyvsp[0].expnode);;
    break;}
case 10:
#line 56 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op, yyvsp[-2].expnode,yyvsp[0].expnode);;
    break;}
case 11:
#line 57 "src/myparser.yacc"
{ yyval.expnode = yyvsp[-1].expnode; ;
    break;}
case 12:
#line 58 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[0].atom,0,0);;
    break;}
case 13:
#line 59 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[0].atom,0,0);;
    break;}
case 14:
#line 60 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[0].op,0,0);;
    break;}
case 15:
#line 62 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[0].id,0,0);;
    break;}
case 16:
#line 63 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[0].id,0,0);;
    break;}
case 17:
#line 64 "src/myparser.yacc"
{yyval.expnode = yyvsp[-1].expnode;;
    break;}
case 18:
#line 65 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op,yyvsp[-2].expnode,yyvsp[0].expnode);;
    break;}
case 19:
#line 66 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op,yyvsp[0].expnode);;
    break;}
case 20:
#line 67 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op,yyvsp[0].expnode);;
    break;}
case 21:
#line 68 "src/myparser.yacc"
{yyval.expnode = new ExpNode(yyvsp[-1].op,yyvsp[-2].expnode,yyvsp[0].expnode);;
    break;}
}
